...
| Public behavior change | README, public docs, CHANGELOG.md | docs mention current behavior |
| Public version bump | `VERSION`, `CHANGELOG.md`, `README.md`, `dev/PROJECT_INDEX.md` Stack | same version appears in all version-bearing public surfaces; changelog uses fixed Traditional Chinese non-developer format |
...
| Release | release notes, README version, CHANGELOG.md, VERSION | release pack checklist; explicit user authorization required |
