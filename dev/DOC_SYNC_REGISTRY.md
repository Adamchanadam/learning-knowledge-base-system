...
| Public writing voice / teaching copy | `docs/公開文案語氣規格.md`, `README.md`, `PUBLICATION_BOUNDARY.md`, `docs/README.md`, public docs, examples, release notes, teaching or installation copy, `dev/PROJECT_INDEX.md` | public copy starts from plain user value, mentions infographics as a core deliverable when explaining product capability, avoids internal / AI-sounding phrasing, and does not present Agent Handoff Kit as the product |
